...
@auth
    ...
    <p>Apakah admin: {{ Auth::user()->is_admin ? 'Ya' : 'Tidak' }}</p>
@else
            ...
            <a href="#" class="d-block text-center mb-4">
              <div class="product-list">
                <div class="product-image position-relative">
                  ...
                  <img
                    src="{{ asset('images/a1.png') }}"
                    alt="products"
                    class="img-fluid product-image-first"
                  />
                  <img
                    src="{{ asset('images/a2.png') }}"
                    alt="products"
            ...
            <a href="#" class="d-block text-center mb-4">
              <div class="product-list">
                <div class="product-image position-relative">
                  <span class="sale">Discount</span>
                  <img
                    src="{{ asset('images/a3.png') }}"
                    alt="products"
                    class="img-fluid product-image-first"
                  />
                  <img
                    src="{{ asset('images/a4.png') }}"
                    alt="products"
                    class="img-fluid product-image-secondary"
                  />
                </div>
            ...
            <a href="#" class="d-block text-center mb-4">
              <div class="product-list">
                <div class="product-image position-relative">
                  <span class="sale">Discount</span>
                  <img
                    src="{{ asset('images/a5.png') }}"
                    alt="products"
                    class="img-fluid product-image-first"
                  />
                  <img
                    src="{{ asset('images/a6.png') }}"
                    alt="products"
                    class="img-fluid product-image-secondary"
                  />
                </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <a href="#" class="d-block text-center mb-4">
              <div class="product-list">
                <div class="product-image position-relative">
                  <img
                    src="{{ asset('images/a7.png') }}"
                    alt="products"
                    class="img-fluid product-image-first"
                  />
                  <img
                    src="{{ asset('images/a8.png') }}"
                    alt="products"
                    class="img-fluid product-image-secondary"
                  />
                </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <a href="#" class="d-block text-center mb-4">
              <div class="product-list">
                <div class="product-image position-relative">
                  <img
                    src="{{ asset('images/a9.png') }}"
                    alt="products"
                    class="img-fluid product-image-first"
                  />
                  <img
                    src="{{ asset('images/a10.png') }}"
                    alt="products"
                    class="img-fluid product-image-secondary"
                  />
                </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <a href="#" class="d-block text-center mb-4">
              <div class="product-list">
                <div class="product-image position-relative">
                  <img
                    src="{{ asset('images/a11.png') }}"
                    alt="products"
                    class="img-fluid product-image-first"
                  />
                  <img
                    src="{{ asset('images/a12.png') }}"
                    alt="products"
                    class="img-fluid product-image-secondary"
                  />
                </div>
