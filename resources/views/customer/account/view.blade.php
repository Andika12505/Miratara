...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ route('homepage') }}">
                <img src="{{ asset('images/logo1.png') }}" alt="MiraTara Logo"> MiraTara
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownUser">
                            <li>
                                <a class="dropdown-item" href="{{ route('customer.account.view') }}">Lihat Akun</a>
                            </li>
                            <li>
                    ...
                    @else
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-primary ms-2" href="{{ route('login_page') }}">Masuk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary ms-2" href="{{ route('register_page') }}">Daftar</a>
                    </li>
                    @endauth
                </ul>
            </div>
                    ...
                    <div class="card-body">
                        <form id="profileForm" enctype="multipart/form-data">
                            ...
                            <div class="text-center mb-4">
                                <img id="photoPreview" src="{{ $user->profile_photo_path ? asset('storage/' . $user->profile_photo_path) : asset('images/default-avatar.png') }}" alt="Foto Profil" class="img-thumbnail rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                            </div>
                            <div class="mb-3">
    ...
    <script>
        ...
        window.customerAccountUpdateProfileUrl = "{{ route('customer.account.update_profile') }}";
        window.customerAccountUpdatePasswordUrl = "{{ route('customer.account.update_password') }}";
        window.checkAvailabilityUrl = "{{ route('admin.check-availability') }}";
    </script>
    <script>
