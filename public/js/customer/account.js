...
// File: public/js/customer/account.js

// --- Global Functions (didefinisikan di <script> di resources/views/customer/account/view.blade.php) ---
// Fungsi-fungsi ini diharapkan sudah ada dan global di view.blade.php
//  - showAlert(message, type)
//  - clearAlert()
//  - togglePassword(fieldId)
//  - debounce(func, wait)
//  - validateField(field, isValid, message)
//  - Global Variables: window.currentUserId, window.customerAccountUpdateProfileUrl, window.customerAccountUpdatePasswordUrl, window.checkAvailabilityUrl
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Ini penting untuk mengatur status tombol submit saat halaman pertama kali dimuat
