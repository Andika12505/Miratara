...
<?php $__env->startSection('title', 'Kelola Produk - Admin MiraTara'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route('admin.products.create_page')); ?>" class="btn btn-primary">
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/admin/admin_products.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\RudalJawa\resources\views\admin\products\index.blade.php ENDPATH**/ ?>