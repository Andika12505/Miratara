...
<?php $__env->startSection('content'); ?>
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route('admin.users.index_page')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <form id="addUserForm" action="#" method="POST" novalidate>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="<?php echo e(route('admin.users.index_page')); ?>" class="btn btn-outline-secondary me-2">
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\RudalJawa\resources\views\admin\users\create.blade.php ENDPATH**/ ?>